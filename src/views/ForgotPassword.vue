...
async requestReset() {
  ...
  try {
    ...
    const apiUrl = `https://cors-proxy-37yu.onrender.com/https://script.google.com/macros/s/AKfycbyxduceUd1Gs0nVTD--NzcpO_is2Yx79YnPO3UU6Qba01QKSYSJkgjCi83AR-QU0QQZSA/exec?route=forgotPassword&email=${encodeURIComponent(this.email)}`;
