...
async function checkAuth() {
  ...
  try {
    ...
    if (!jwt) {
      console.warn("⚠️ Aucun JWT trouvé. L'utilisateur est déconnecté.");
      isLoading.value = false;  // ✅ Libérer l'affichage
      return; // ✅ STOP ici pour éviter de charger un utilisateur inexistant
    }
