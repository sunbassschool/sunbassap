<template>
  ...
  <!-- Interface principale avec Layout -->
  <div v-show="!isLoading" class="app-container">
    <router-view /> <!-- ✅ Affiche le layout même si l'auth est en attente -->
  </div>
</template>
...
onMounted(async () => {
  ...
  try {
    ...
    isLoading.value = false; // ✅ Cache l'écran de chargement après la vérification
  }
});
</script>
