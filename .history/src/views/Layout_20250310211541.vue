...
.navbar-nav .nav-link {
  ...
  font-size: 28px; /* ✅ Évite les changements de taille */
  transition: none !important; /* 🔥 Supprime les animations inutiles */
  line-height: 1; /* ✅ Assure une hauteur stable */
}
...
@media screen and (min-width: 1024px) {
  ...
  .navbar-nav .nav-link i {
    font-size: 0px; /* Agrandit les icônes */
  }
}
