<template>
  ...
  // Ajuste la fréquence si elle est proche du double ou du multiple d'une note
  while (detectedFreq > closestNote.frequency * 2) {
    detectedFreq /= 2; // Divise la fréquence détectée si elle est un harmonique
  }
