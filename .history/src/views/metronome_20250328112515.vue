...
export default {
  ...
  data() {
    return {
      ...
      timerColor: "white",
      timerInterval: null,
      wasPlayingBeforeHide: false, // Nouvelle variable pour suivre l'état
      subdivisions: [
  ...
  methods: {
    ...
    startMetronome() {
      ...
      this.nextNoteTime = this.audioContext.currentTime + 0.1; // Petit délai pour éviter les problèmes
      this.startTimer();
