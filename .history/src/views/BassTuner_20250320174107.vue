  ...
  methods: {
    ...
    detectFrequency() {
      ...
      for (let note of this.notes) {
        ...
        // Si la fréquence détectée est proche d'un multiple supérieur de la fondamentale (par exemple 3x)
        if (Math.abs(detectedFreq - note.frequency * 3) <= tolerance) {
          detectedFreq = note.frequency; // Ramener la fréquence à la fondamentale
          closestNote = note;
          break;
        }
      }
