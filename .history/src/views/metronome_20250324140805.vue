...
,
startMetronome() {
  // Vérifie si le métronome est déjà en cours dans la session
  ...
  this.isPlaying = true;
  sessionStorage.setItem("isPlaying", "true"); // Sauvegarde de l'état dans sessionStorage
...
stopMetronome() {
  ...
  sessionStorage.setItem("isPlaying", "false"); // Réinitialise l'état dans sessionStorage
  this.nextNoteTime = 0;
