      ...
      <div class="metronome-card">
        <div class="card-body">
          <div class="mixette-layout">
            ...
            <!-- COLONNE DROITE : SUBDIVISIONS AVEC ICONES -->
            <div class="subdivision-section">
              ...
              <select v-model="subdivision" class="subdivision-select">
...
.volume-section, .subdivision-section {
  flex: 1;
  min-width: 250px;
