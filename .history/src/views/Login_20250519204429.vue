...
export default {
  ...
  data() {
    return {
      ...
      jwt: "",
      refreshToken: "",
      apiBaseURL: "https://cors-proxy-sbs.vercel.app/api/proxy?url=https://script.google.com/macros/s/AKfycbwCrvZUTP9W0dGCzgMO_wdfgQWXeke3xAWLiXIIR8TdT57IWE3V90xj_E2JZOxrtx4n2A/exec",
      loading: false,
      progress: 0,
