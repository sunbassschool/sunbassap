<template>
  <div class="layout-container">
    ...
    <MiniMetronome v-if="showMiniMetronome" />
...
<aside class="sidebar" :class="{ isCollapsed: isSidebarCollapsed }" v-if="!isMobile">
  ...
  <span>Prendre un cours</span>
   ...
   <router-link class="sidebar-link" to="/dashboard">
    ...
    <router-link v-if="isLoggedIn && !isAdmin"    to="/MesRessources" class="sidebar-link">
...
<router-link v-if="isLoggedIn && !isAdmin"to="/Feedback" class="sidebar-link">
 ...
 <router-link v-if="!isLoggedIn" to="/registerform" class="sidebar-link">
  ...
  <span>S'inscrire</span>
    ...
    <router-link v-if="isLoggedIn && !isAdmin"    class="sidebar-link" to="/mon-espace">
...
<div class="desktop-auth-buttons">
  ...
  <span>Déconnexion</span>
    ...
    <!-- ✅ Menu latéral version Mobile responsive -->
    <div v-if="showMenu" class="menu-overlay" @click="toggleMenu"></div>
    <div class="mobile-menu" :class="{ 'active': showMenu }">
      <router-link to="/mon-espace" class="nav-link mon-espace" v-if="isLoggedIn && !isAdmin"      >

        <i class="bi bi-person-circle"></i>
        <span>Mon Espace</span>
      </router-link>
      <router-link to="/Metronome" class="nav-link mon-espace" v-if="isLoggedIn">

        
<span>🥁Metronome</span>
</router-link>
<router-link to="/BassTuner" class="nav-link mon-BassTuner" v-if="isLoggedIn">


<span>🎸 Accordeur</span>
</router-link>
<router-link to="/MesRessources" class="nav-link mon-BassTuner" v-if="isLoggedIn">


<span> Mes Ressources</span>
</router-link>
<router-link to="/Feedback" class="nav-link mon-BassTuner" v-if="isLoggedIn && !isAdmin">


<span> Feedback</span>
</router-link>
<router-link to="/login" class="nav-link mon-espace" v-if="!isLoggedIn">Se connecter</router-link>
     <a v-if="!isAdmin"
...
<router-link v-if="isAdmin" to="/AdminFeedBack" class="nav-link mon-espace">
  <i class="bi bi-pencil-square"></i>
  <span>AdminFeedBack</span>
</router-link>
<router-link v-if="isAdmin" to="/CreatePlanning" class="nav-link mon-espace">
  <i class="bi bi-pencil-square"></i>
  <span>Créer un planning de l'élève</span>
</router-link>
...
<li class="nav-item">
          <router-link class="nav-link" v-if="!isLoggedIn" to="/BassTuner">
...
watch(showMiniMetronome, (newValue) => {
    console.log("showMiniMetronome has changed:", newValue)
  })
    ...
    return {
      ...
      isAdmin,
      isMobile,
      showMiniMetronome, // ✅ Ajoute-le ici
