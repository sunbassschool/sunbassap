...
,
    ...
    // ✅ Si l’API ne fournit pas `espace_google_drive`, on garde celle du cache
    if (data.espace_google_drive === undefined || data.espace_google_drive === null) {
        updatedData.espace_google_drive = cachedData.espace_google_drive || "";
    }

    // ✅ Si l’API ne fournit pas `playlist_youtube`, on garde celle du cache
    if (data.playlist_youtube === undefined || data.playlist_youtube === null) {
