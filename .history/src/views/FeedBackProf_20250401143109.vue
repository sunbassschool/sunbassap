...
export default {
  ...
  data() {
    return {
      ...
      routes: {
        GET: "AKfycbzF_bzmRS1VMGgkzJMqEuq-rb-45-_sAyEV2QXuCQUHx7EzfGDnpuEvi1x2o6L4jj5XXQ/exec",
        POST: "AKfycbzF_bzmRS1VMGgkzJMqEuq-rb-45-_sAyEV2QXuCQUHx7EzfGDnpuEvi1x2o6L4jj5XXQ/exec",
      },
    };
  },
  async mounted() {
