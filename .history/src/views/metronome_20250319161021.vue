...
.control-buttons {
  ...
  justify-content: center; /* Centrer les éléments horizontalement */
  gap: 10px; /* Espacement entre l'icône et le BPM */
}
#beatCircle {
  width: 50px; /* Ajuste la taille ici si nécessaire */
  height: 50px; /* Ajuste la taille ici si nécessaire */
  border-radius: 50%;
  display: flex;
  align-items: center;
  justify-content: center;
  font-size: 18px; /* Taille du texte à l'intérieur du cercle */
  font-weight: bold;
  color: black;
...
.control-group span {
  font-size: 4rem;  /* Ajuste la taille ici */
  font-weight: bold; /* Optionnel, pour rendre le texte plus épais */
}
