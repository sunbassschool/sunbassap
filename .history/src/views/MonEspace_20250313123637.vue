...
if (jwt) {
  try {
    ...
    // Extrait le rôle et le prénom
    this.user.role = decoded.role;
    this.user.prenom = decoded.prenom;  // Ajoute l'extraction du prénom

    // Sauvegarde dans localStorage pour une utilisation future
    localStorage.setItem("role", this.user.role);
    localStorage.setItem("prenom", this.user.prenom);  // Sauvegarde du prénom
  } catch (error) {
