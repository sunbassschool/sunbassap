...
<div v-if="loginSuccess" class="success-feedback text-center">
  <div class="checkmark-circle">
    <div class="background"></div>
    <div class="checkmark"></div>
  </div>
  <p class="mt-3 text-success fw-bold">Connexion réussie, redirection...</p>
</div>
...
export default {
  ...
  data() {
    return {
      ...
      jwt: "",
      refreshToken: "",
      apiBaseURL: "https://cors-proxy-37yu.onrender.com/https://script.google.com/macros/s/AKfycbwaBhzwN9GTIT--QNosfSbPxwR9j66J08cpqf6lvFiDlOY3m0iZk5Vmh-KJo6P341HCgA/exec",
      loading: false,
      progress: 0,
...
,
  ...
  try {
    ...
    console.timeEnd("⏱️ Login duration");
    this.setMessage("✅ Connexion réussie, redirection...", "alert-success");
