...
const goToNextWeek = () => {
  ...
  if (currentIndex !== -1 && currentIndex < weeks.value.length - 1) {
    ...
    const API_URL =
      "https://cors-proxy-37yu.onrender.com/https://script.google.com/macros/s/AKfycbykYySA5D4taWYaICxCHt6l3WmOM5RNg4P_rCoJowfxusXpSy5D-ZuGFao9UjGWHD86AA/exec";
  ...
  try {
    ...
    const targetBase = "https://script.google.com/macros/s/AKfycbyBrhgMrzK14HMgiYI5SgkiJElfTmdX70RSnNJ85nw_6mVCIY4vrt2vL-DTMCEtu6mB4A/exec";
...
const selectClosestWeek = () => {
  ...
  try {
    ...
    const targetURL = `https://script.google.com/macros/s/AKfycbyBrhgMrzK14HMgiYI5SgkiJElfTmdX70RSnNJ85nw_6mVCIY4vrt2vL-DTMCEtu6mB4A/exec?jwt=${encodeURIComponent(jwt)}`;
