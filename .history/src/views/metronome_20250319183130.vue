...
{ value: 4, label: '', icon: './assets/icons/sixteenth-note.png' }
  ...
  methods: {
    async loadSounds() {
      ...
      this.soundBuffers.strong = await this.loadSound('./audios/strong-beat.wav');
this.soundBuffers.weak = await this.loadSound('./audios/weak-beat.wav');
this.soundBuffers.sub = await this.loadSound('./audios/subdivision.wav');
