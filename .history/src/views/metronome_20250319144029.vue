...
.control-group select {
  ...
  width: 100%; /* S'assurer que le select prend toute la largeur disponible */
...
.control-group select:focus {
  border-color: #28a745; /* Changer la couleur de la bordure au focus */
  background-color: #444; /* Changer légèrement la couleur de fond au focus */
}

.control-group select::-ms-expand {
  display: none; /* Enlever la flèche pour les navigateurs IE */
}

/* Ajouter une flèche personnalisée */
.control-group select::-webkit-appearance: none;
.control-group select::-moz-appearance: none;
