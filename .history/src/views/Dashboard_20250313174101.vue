...
@media (max-width: 768px) {
  .dashboard-card h3 {
    font-size: 1rem; /* 📏 Réduction du titre */
  }

  .dashboard-card p {
    font-size: 0.10rem; /* 📏 Réduction du texte sous le titre */
  }
  
.dashboard-card {
    padding: 10px; /* 📏 Réduit l’espace intérieur */
    min-height: auto !important; /* ✅ Évite que la carte soit trop grande */
  }
  ...
  .dashboard-card p {
    margin-bottom: 0px; /* 📏 Évite trop d’espace sous le texte */
  }
}
h3 {
  font-size: 1.2rem;
