...
export default {
  ...
  return {
    ...
    swingAmount: 0,
    isPlaying: false,
    isSwingEnabled: false, // ✅ Par défaut, le swing est désactivé
    swingAmount: 0.5, // Valeur fixe du swing (ex: 66% swing jazz)
    elapsedTime: 0,
    audioContext: null,
    nextNoteTime: 0.0,
    currentBeat: 1,
...
{ value: 4, label: '', icon: './assets/icons/sixteenth-note.png' }
  ...
  while (this.nextNoteTime < now + 0.1) {
    ...
    // ✅ Appliquer le swing UNIQUEMENT si activé
    let swingOffset = (this.isSwingEnabled && this.currentSubdivision % 2 === 0) 
...
input:checked + .slider {
  background-color: #a72c28; /* Rouge Swing */
}
