        ...
        <div class="card-body">
          <div class="control-buttons">
            ...
            <div class="visualizer">
              <div 
  :class="['beat-circle', { beat: isBeating, 'primary-beat': isBeating && currentBeat === 1 }]" 
  id="beatCircle"
>
...
.control-icon {
  ...
  border: 2px solid #888; /* Bordure claire */
...
/* Lueur rouge sur le premier beat */
#beatCircle.primary-beat {
  box-shadow: 0 0 25px 6px rgba(255, 0, 0, 0.85);
}
