<template>
  <Layout>
    ...
    <!-- ✅ Loader Global -->
    <div v-if="loading || !isDataReady" class="loading-container">
    ...
    <!-- ✅ Carte affichée UNIQUEMENT quand data prête -->
    <div v-else class="d-flex justify-content-center w-100 mt-0">
                ...
                <div v-else class="d-flex align-items-center justify-content-between w-100">
                  <span class="badge bg-warning text-dark fs-5 text-wrap flex-grow-1 text-center">
                    💪 <span class="text-break fw-bold lh-sm">
                      {{ user.objectif || "🎯 Aucun objectif défini !" }}
                    </span>
                  </span>
                  <span class="editable" @click="editObjectif" title="Modifier l'objectif"> ✏️ </span>
                </div>

                <button v-if="isEditing" @click="saveObjectif" class="btn btn-link p-0 text-success">💾</button>
              </div>
                ...
                <div class="modal-content" @click.stop>
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li class="py-2">
                      ...
                      <input v-else v-model="user.telephone" type="text" class="form-control form-control-sm d-inline-block w-auto" @blur="updateInfosPerso" @keyup.enter="updateInfosPerso" ref="telephoneInput">
                    </li>
                    <li class="py-2">
                      ...
                      <input ref="objectifInput" v-show="isEditingInfo === 'objectif'" v-model="user.objectif" class="form-control form-control-sm input-objectif" @keyup.enter="updateObjectif" @blur="updateUserData" />
                    </li>
                    ...
                    <div class="d-flex justify-content-center">
                      <router-link to="/forgot-password" class="forgot-password-link">Modifier mon mot de passe</router-link>
                    </div>
                  </ul>
                </div>
              </div>
...
routes: {
  ...
  POST: "AKfycbykYySA5D4taWYaICxCHt6l3WmOM5RNg4P_rCoJowfxusXpSy5D-ZuGFao9UjGWHD86AA/exec"
},
fetchURL(route) {
