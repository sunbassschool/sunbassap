  ...
  export default {
    ...
    methods: {
      ...
      detectFrequency() {
        ...
        // Comparaison directe avec les notes fondamentales
        let closestNote = this.notes.reduce((prev, curr) => {
          const diff = Math.abs(curr.frequency - detectedFreq);
          return (diff < Math.abs(prev.frequency - detectedFreq)) ? curr : prev;
        });
  
        // Mise à jour de la note et de la fréquence
        ...
        // Relance l'analyse à chaque frame
