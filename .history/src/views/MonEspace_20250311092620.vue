...
fetchURL(route) {
  ...
  // ✅ Charge les données depuis le cache en premier
  ...
  // ✅ Rafraîchit les données en arrière-plan sans effacer immédiatement le cache
  setTimeout(async () => {
...
updateLocalCache(data) {
  ...
  // ✅ Ne pas écraser ces valeurs si elles ne sont pas renvoyées
  ...
  console.log("💾 Sauvegarde du cache :", updatedData);
