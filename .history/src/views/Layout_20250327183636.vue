...
<div
  id="refresh-overlay"
  style="display: none; position: fixed; z-index: 9999; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(0,0,0,0.5); backdrop-filter: blur(4px); justify-content: center; align-items: center; color: white; font-size: 1.5rem; text-align: center;"
  class="d-flex"
>
  <div>
    <i class="fas fa-sync fa-spin" style="font-size: 2rem;"></i>
...
watch(showMiniMetronome, (newValue) => {
    ...
    return {
      ...
      isRefreshing, // remplace la version actuelle
