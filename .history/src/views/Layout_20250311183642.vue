...
const checkLoginStatus = async () => {
    ...
    console.log("📌 Vérification `localStorage`:", localStorage.getItem("jwt"));
    console.log("📌 Vérification `sessionStorage`:", sessionStorage.getItem("jwt"));

    let token = await getToken();

    console.log("📌 Token final après `getToken()`: ", token);
