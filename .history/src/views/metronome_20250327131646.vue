...
const subdivisions = [
  { value: 1, label: '', icon: '${import.meta.env.VITE_BASE_URL}assetsassets/icons/quarter-note.png' },
  { value: 2, label: '', icon: '${import.meta.env.VITE_BASE_URL}assetsassets/icons/eighth-note.png' },
  { value: 3, label: '', icon: '${import.meta.env.VITE_BASE_URL}assetsassets/icons/triplet.png' },
  { value: 4, label: '', icon: '${import.meta.env.VITE_BASE_URL}assetsassets/icons/sixteenth-note.png' }
]
