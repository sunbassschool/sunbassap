...
fetchURL(route) {
  ...
  async mounted() {
    await this.checkUserRole(); // 🔥 Vérification asynchrone du rôle
  if (this.isInitialized) return;  // 🔥 Bloque l'exécution multiple
