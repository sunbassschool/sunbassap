...
,
  ...
  try {
    ...
    if (data.status !== "error") {
      ...
      // ✅ Met à jour le cache principal (`userData_{prenom}`)
      this.updateLocalCache({ objectif: nouvelObjectif });

      // ✅ Met à jour le cache `userInfos_{prenom}` pour le Dashboard
      const userInfosKey = `userInfos_${this.prenom}`;
      ...
      console.log("✅ Objectif mis à jour dans tous les caches !");
    } else {
