<template>
  ...
  // Ajout d'une division pour Ré (D) et Sol (G) si nécessaire
  if (detectedFreq > 120 && detectedFreq < 150) {
    detectedFreq /= 2;  // Réduit la fréquence détectée à la fondamentale si elle est une harmonique
  }

  if (detectedFreq > 180 && detectedFreq < 220) {
    detectedFreq /= 2;  // Réduit la fréquence détectée à la fondamentale pour Sol
  }
