...
const goToNextWeek = () => {
  ...
  if (currentIndex !== -1 && currentIndex < weeks.value.length - 1) {
    ...
    const API_URL =
      "https://cors-proxy-37yu.onrender.com/https://script.google.com/macros/s/AKfycbyvFb607O-JB2ZGgY9Ei1IPdoIA_AjsgdcZ_oRlBc6z1w2gK3nMnq-Sp0R6VrUoNO5lIg/exec";
  ...
  try {
    ...
    const targetBase = "https://script.google.com/macros/s/AKfycbwCrvZUTP9W0dGCzgMO_wdfgQWXeke3xAWLiXIIR8TdT57IWE3V90xj_E2JZOxrtx4n2A/exec";
...
const selectClosestWeek = () => {
  ...
  try {
    ...
    const targetURL = `https://script.google.com/macros/s/AKfycbwCrvZUTP9W0dGCzgMO_wdfgQWXeke3xAWLiXIIR8TdT57IWE3V90xj_E2JZOxrtx4n2A/exec?jwt=${encodeURIComponent(jwt)}`;
  ...
  try {
    ...
    const targetURL = `https://script.google.com/macros/s/AKfycbyvFb607O-JB2ZGgY9Ei1IPdoIA_AjsgdcZ_oRlBc6z1w2gK3nMnq-Sp0R6VrUoNO5lIg/exec?jwt=${encodeURIComponent(jwt)}`;
    const proxyUrl = `https://cors-proxy-sbs.vercel.app/api/proxy?url=${encodeURIComponent(targetURL)}`;
