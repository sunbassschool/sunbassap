...
function startMetronome() {
  metronome.startMetronome(); // 🔥 wake lock & nosleep appelés immédiatement
...
<style scoped>
html, body {
  height: 100%; /* Assure que la hauteur est à 100% de l'écran */
...
@media (max-width: 768px) {
  ...
  display: flex;
  flex-direction: row;
  position: relative; /* Ajoute ça si ce n’est pas déjà là */
  max-height: 100vh; /* Empêche la section de dépasser la hauteur de l'écran */
...
.metronome-container {
  ...
  flex-direction: column; /* Assure un agencement correct des éléments */
