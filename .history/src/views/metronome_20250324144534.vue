...
stopAudio() {
  // Arrêter tous les sons en cours sans fermer l'AudioContext
  if (this.audioContext) {
    this.soundBuffers = { strong: null, weak: null, sub: null }; // Réinitialise les buffers
    // Si tu veux, tu peux réinitialiser d'autres éléments ici
  }
},

startMetronome() {
  // Si le AudioContext est fermé ou null, on le réinitialise
  if (!this.audioContext || this.audioContext.state === "closed") {
    this.initAudioContext(); // Réinitialise l'AudioContext
  }
  ...
  this.resumeAudioContext(); // Reprend le AudioContext s'il est en pause
  this.isPlaying = true;
