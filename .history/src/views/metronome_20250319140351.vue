  ...
  export default {
    ...
    data() {
      return {
        ...
        subdivisions: [
          { value: 1, label: 'Noires', icon: 'path/to/quarter-note-icon.png' }, // Remplace par le bon chemin de l'icône
          { value: 2, label: 'Croches', icon: 'path/to/eighth-note-icon.png' }, // Remplace par le bon chemin de l'icône
          { value: 3, label: 'Triolets', icon: 'path/to/triplet-icon.png' }, // Remplace par le bon chemin de l'icône
          { value: 4, label: 'Doubles Croches', icon: 'path/to/sixteenth-note-icon.png' } // Remplace par le bon chemin de l'icône
        ]
      };
    },
    methods: {
