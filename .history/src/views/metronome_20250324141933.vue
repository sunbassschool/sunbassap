...
stopMetronome() {
  ...
  localStorage.setItem("isPlaying", "false"); // Réinitialise l'état dans localStorage
  this.nextNoteTime = 0;
...
beforeUnmount() {
  this.checkIfPlaying(); // Vérifie si le métronome est déjà en cours avant que la page ne soit monté
  this.stopMetronome();
