<template>
  ...
  export default {
    ...
    // 🔥 Stoppe le son si une note est déjà en cours
    ...
    // 🔥 Crée un oscillateur principal (fréquence normale)
    ...
    // 🔥 Crée un oscillateur secondaire (octave +1, fréquence * 2)
    ...
    // 🔊 Ajuster le volume pour éviter une saturation (basse = plus fort, harmonique = plus doux)
    ...
    gainNode2.gain.linearRampToValueAtTime(0.2, this.audioContext.currentTime + 0.1); // Volume de l'harmonique
