...
.hero-subtitle {
  ...
  animation: colorFade 4s infinite alternate; /* Animation continue */
}

@keyframes colorFade {
  0% {
    color: #9b9b9b; /* Couleur initiale */
  }
  100% {
    color: #ff8c00; /* Couleur finale (ou une autre couleur professionnelle) */
  }
}
