...
export default {
  ...
  setup() {
    ...
    const toggleMenu = () => {
  console.log("Toggle menu", showMenu.value);
  showMenu.value = !showMenu.value;
    ...
    return {
      user, isLoggedIn, isAdmin, refreshKey, isRefreshing, refreshFailed,
      isMobile, showResponsiveLogo, showMenu, isSidebarCollapsed, showInstallButton,
      handleTokenRefresh, logout, clearIndexedDB, unregisterServiceWorkers, installPWA, checkMobile,toggleMenu,
    };
  }
};
</script>
