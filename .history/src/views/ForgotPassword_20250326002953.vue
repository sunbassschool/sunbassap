...
export default {
  ...
  try {
    ...
    const targetURL = `https://script.google.com/macros/s/AKfycbykYySA5D4taWYaICxCHt6l3WmOM5RNg4P_rCoJowfxusXpSy5D-ZuGFao9UjGWHD86AA/exec?route=forgotPassword&email=${encodeURIComponent(this.email)}`;
