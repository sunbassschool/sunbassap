...
export default {
  ...
  data() {
    return {
      ...
      jwt: "",
      refreshToken: "",
      apiBaseURL: "https://cors-proxy-sbs.vercel.app/api/proxy?url=https://script.google.com/macros/s/AKfycbwEHhLoAVs9Lsn5HKfPnhB2gRAU2OBCeCTgTSK7CgV0ZMdqW_EQD2iyWZhCqc_UHLykog/exec",
      loading: false,
      progress: 0,
