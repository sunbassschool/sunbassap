<template>
  <Layout>
    <div class="container py-4">
      ...
      <p style="font-size: 0.75rem; word-break: break-all;" class="text-warning">
  {{ getImageProxyURL(file['Lien direct']) }}
</p>
          ...
          <div class="resource-carousel">
            ...
            >
              ...
              <div v-if="file['Type de ressource'] === 'Image' && file['Lien direct']">
                <img 
  :src="getImageProxyURL(file['Lien direct'])"
...
export default {
  ...
  return `https://cors-proxy-sbs.vercel.app/api/proxy?url=${encodeURIComponent(url)}`;
}
,
