...
async loadRessources() {
  const routeId = "AKfycbyAFL1sQ2OuXOhkqROMgfKYdnGbYbH7sXiVm3uvPMtueESa6chVfsojHxZvYFqf1AXUzg/exec"; // Ton script Apps Script
  ...
  try {
    ...
    // ➕ À toi d’adapter le stockage ou l'affichage
    this.files = data;
