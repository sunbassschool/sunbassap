...
updateTimer() {
 if (this.isPlaying) {
      const currentTime = Math.floor((Date.now() - this.startTime) / 1000); // Temps en secondes entières
      this.formattedTime = this.formatTime(currentTime);  // Appliquer la fonction de formatage
