...
startMetronome() {
    if (this.isPlaying) return;  // Empêche de démarrer un clic si déjà en cours

    // Vérifie si un clic est déjà en cours, si oui, ne rien faire
  ...
  stopMetronome() {
    ...
    sessionStorage.setItem("isPlaying", "false"); // Réinitialise l'état
    this.nextNoteTime = 0;
