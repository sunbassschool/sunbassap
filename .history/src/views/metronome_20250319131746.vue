<template>
    <Layout>
      <div class="metronome-container">
        ...
        <!-- Nouvelle card pour les boutons de pulsation et de contrôle -->
        <div class="control-card">
          <div class="card-header">
            <h2>Contrôles du Métronome</h2>
          </div>
          <div class="card-body">
        ...
        <!-- Ancienne card : Contrôles du Métronome et Mixage des Volumes -->
  ...
  /* Card pour les boutons de contrôle */
  .control-card {
    background: #333;
    border-radius: 8px;
    margin: 15px 0;
