...
export default {
  ...
  methods: {
    async verifyToken() {
      ...
      try {
        const baseScriptURL = "https://script.google.com/macros/s/AKfycbwCrvZUTP9W0dGCzgMO_wdfgQWXeke3xAWLiXIIR8TdT57IWE3V90xj_E2JZOxrtx4n2A/exec";
...
const response = await fetch(proxyURL);
  ...
  try {
    ...
    const baseScriptURL = "https://script.google.com/macros/s/AKfycbyvFb607O-JB2ZGgY9Ei1IPdoIA_AjsgdcZ_oRlBc6z1w2gK3nMnq-Sp0R6VrUoNO5lIg/exec";
