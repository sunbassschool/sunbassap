...
export default {
  ...
  methods: {
    async verifyToken() {
      ...
      try {
        const baseScriptURL = "https://script.google.com/macros/s/AKfycbykYySA5D4taWYaICxCHt6l3WmOM5RNg4P_rCoJowfxusXpSy5D-ZuGFao9UjGWHD86AA/exec";
...
const response = await fetch(proxyURL);
  ...
  try {
    ...
    const baseScriptURL = "https://script.google.com/macros/s/AKfycbyBrhgMrzK14HMgiYI5SgkiJElfTmdX70RSnNJ85nw_6mVCIY4vrt2vL-DTMCEtu6mB4A/exec
";
