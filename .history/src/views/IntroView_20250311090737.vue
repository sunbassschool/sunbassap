...
import { refreshToken, getToken, getRefreshTokenFromDB, isJwtExpired, verifyIndexedDBSetup, preventIndexedDBCleanup, checkAndRestoreTokens } from "@/utils/api";
...
import { preventIndexedDBCleanup, checkAndRestoreTokens } from "@/utils/api"; // ✅ Importe les fonctions
