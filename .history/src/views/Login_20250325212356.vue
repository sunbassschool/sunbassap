...
export default {
  ...
  data() {
    return {
      ...
      jwt: "",
      refreshToken: "",
      apiBaseURL: "https://cors-proxy-vercel-sbs.vercel.app
/https://script.google.com/macros/s/AKfycbyvb0EneHzbds5HHSPtmEU_PmfbHBbup9-FpfQ3vMsHlH4vljfyoxCZEL3ywTmLs15a6A/exec",
      loading: false,
      progress: 0,
