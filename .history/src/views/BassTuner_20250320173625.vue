...
export default {
  ...
  methods: {
    ...
    detectFrequency() {
      ...
      // Tolérance pour les notes : on élargit la tolérance à 7 Hz pour permettre des petites variations
      const tolerance = 7; // Tolérance de 7 Hz pour les variations plus larges
