...
import quarterNote from './assets/icons/quarter-note.png';
import eighthNote from './assets/icons/eighth-note.png';
import triplet from './assets/icons/triplet.png';
import sixteenthNote from '@/assets/icons/sixteenth-note.png';
...
export default {
  ...
  return {
    ...
    subdivisions: [
  { value: 1, label: "Noire", icon: quarterNote },
  { value: 2, label: "Croche", icon: eighthNote },
  { value: 3, label: "Triolet", icon: triplet },
  { value: 4, label: "Double-croche", icon: sixteenthNote }
]
