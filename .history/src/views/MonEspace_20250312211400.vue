      ...
      <div class="row justify-content-center">
        <div class="col-lg-12 col-md-10 w-100">
          <div class="card glass-card p-4 text-center animated-card">
            ...
            <!-- 🚀 Loader amélioré avec gestion stable -->
            <div v-if="loadState === 'loading'" class="loading-container">
            ...
            <!-- ❌ Message d'erreur -->
            <div v-else-if="loadState === 'error'" class="alert alert-danger">
              <strong>❌ Oups !</strong> Impossible de charger les données. Veuillez réessayer.
            </div>
            ...
            <div v-else class="info-section">
              ...
              <div class="info-box goal-box text-center" :class="{ 'shake': isSaving, 'pulse': savedAnimation }">
                <input 
                  v-if="isEditing" 
...
mounted() {
  ...
  setTimeout(async () => {
    ...
    this.isDataReady = true; // ✅ Maintenant les blocs peuvent s'afficher correctement
  }, 500);
...
async fetchUserData() {
    ...
    try {
      ...
      if (!data.error) {
        ...
        this.loadState = "ready"; // ✅ Seulement quand tout est OK
      } else {
...
async loadUserData() {
  ...
  if (cachedData && cacheExpiration && Date.now() < parseInt(cacheExpiration)) {
    ...
    this.isDataReady = true; // ✅ Active immédiatement `isDataReady`
