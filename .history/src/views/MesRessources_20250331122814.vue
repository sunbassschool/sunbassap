<template>
  <Layout>
    <div class="container py-4">
      <h2 class="mb-4 text-light">🎒 Mes Res<img src="https://drive.google.com/uc?export=view&id=1nEZR6-t2RmWiyObqdmdvYDXK4FTx8el7" />
        sources</h2>
      ...
      <div v-if="showModal && selectedFile" class="modal-backdrop-custom" @click.self="closePreview">
        <div class="modal-content-custom">
          ...
          <img 
            :src="selectedFile['Lien direct']"
            :alt="selectedFile['Nom du fichier']"
            class="img-fluid rounded"
            @error="$event.target.src = '/images/image-not-found.png'"
          />
          <p class="text-muted small">{{ selectedFile['Lien direct'] }}</p>
