    ...
    <div class="register-container">
      ...
      <form @submit.prevent="submitForm" class="card p-4 shadow">
        ...
        <div class="mb-3">
          ...
          <input v-model="email" type="email" class="form-control" :class="{ 'shake': emailError }" required autocomplete="email" />
        ...
        <div class="mb-3">
          ...
          <input v-model="prenom" type="text" class="form-control" required autocomplete="given-name" />
...
<div class="mb-3 password-container">
  ...
  <div class="password-wrapper">
    <input v-model="codeAcces" type="password":type="showPassword ? 'text' : 'password'"  class="form-control" :class="{ 'shake': passwordError }" required autocomplete="new-password" />
