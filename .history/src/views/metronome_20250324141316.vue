...
,
  ...
  this.requestWakeLock(); // Lancer une première fois au démarrage
},

beforeUnmount() {
  this.stopMetronome();
  document.body.style.overflow = ""; // Rétablit le scroll
  document.removeEventListener('visibilitychange', this.handleVisibilityChange); // Nettoyer l'événement
},
