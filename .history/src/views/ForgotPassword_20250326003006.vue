...
export default {
  ...
  try {
    ...
    const targetURL = `https://script.google.com/macros/s/AKfycbyBrhgMrzK14HMgiYI5SgkiJElfTmdX70RSnNJ85nw_6mVCIY4vrt2vL-DTMCEtu6mB4A/exec
?route=forgotPassword&email=${encodeURIComponent(this.email)}`;
