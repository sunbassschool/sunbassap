...
,
  ...
  consasync fetchNote(forceRefresh = false) {
ole.log("📝 Récupération de la note...");
  this.saving = true;
  this.isRefreshingNote = forceRefresh;

  // ✅ Vérification d'authentification globale via App.vue
  if (!this.$root.checkAuth()) {
    console.warn("❌ Utilisateur non authentifié. Annulation de la récupération de note.");
    return;
  }
