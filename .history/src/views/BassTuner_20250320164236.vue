<template>
  ...
  // Limitation des fréquences élevées (plus de 200 Hz)
  while (detectedFreq > 200) {
    detectedFreq /= 2;
  }

  // Ajustement pour les harmoniques, on ne garde que la fréquence la plus proche d'une note
  ...
  if (Math.abs(detectedFreq - closestNote.frequency * 2) < 2) {
    detectedFreq /= 2;
  }
