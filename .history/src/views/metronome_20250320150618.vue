...
export default {
  ...
  return {
    ...
    subdivisions: [
      { value: 1, label: "Noire", icon: require('@/assets/icons/quarter-note.png') },
      { value: 2, label: "Croche", icon: require('@/assets/icons/eighth-note.png') },
      { value: 3, label: "Triolet", icon: require('@/assets/icons/triplet.png') },
      { value: 4, label: "Double-croche", icon: require('@/assets/icons/sixteenth-note.png') }
    ]
  };
},
