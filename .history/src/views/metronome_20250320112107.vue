...
async mounted() {
  ...
  if ("wakeLock" in navigator) {
    try {
      ...
      // 💡 Surveiller si le wakeLock est relâché et le réactiver
      this.wakeLock.addEventListener("release", () => {
        console.log("Wake Lock relâché, tentative de réactivation...");
  ...
  // 🟡 Préparer le faux son pour iOS, mais ne pas le jouer immédiatement
