...
import {  getToken, isUserLoggedIn, isUserAdmin, clearUserData, restoreTokensToIndexedDB, setTokenCookies, logoutUser, preventIndexedDBCleanup, checkAndRestoreTokens, refreshToken, syncTokens    } from "@/utils/api.ts";
...
onMounted(async () => {
  ...
  // Synchronise les tokens avant toute autre logique
  await syncTokens();
