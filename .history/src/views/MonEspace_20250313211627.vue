...
/>
  ...
  {{ console.log("🎯 Objectif rendu :", user.objectif) || user.objectif || "🎯 Aucun objectif défini pour le moment. Fixe-toi un challenge !" }}
</span>
...
async fetchUserData(forceUpdate = false) {
  ...
  try {
    ...
    if (!data.error) {
      ...
      console.log("✅ Objectif mis à jour après API :", this.user.objectif);
