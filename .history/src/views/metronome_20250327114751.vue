<template>
<layout>
     <!-- Le widget du métronome ne s'affiche que si on est PAS sur la page metronome.vue -->
     <div v-if="!isMetronomePage">
      <metronome-widget />
    </div>
...
const isMetronomePage = ref(true) // Définis ici à `true` pour ne pas afficher le widget sur cette page
