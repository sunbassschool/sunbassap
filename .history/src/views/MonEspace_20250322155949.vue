...
startOnboarding() {
  ...
  tour.addStep({
    title: '🎯 Ton Objectif',
    text: 'Définis ici ton objectif personnel ! Clique sur ✏️ pour le modifier.',
    attachTo: { element: '.goal-box', on: 'bottom' },
    buttons: [
  ...
  tour.addStep({
    ...
    text: 'Accède à ton Google Drive et tes vidéos ici.',
    attachTo: { element: '.resource-box', on: 'top' },
    buttons: [
