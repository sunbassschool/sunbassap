...
export default {
  ...
  methods: {
    async verifyToken() {
      ...
      try {
        const response = await fetch(`https://cors-proxy-37yu.onrender.com/https://script.google.com/macros/s/AKfycbykYySA5D4taWYaICxCHt6l3WmOM5RNg4P_rCoJowfxusXpSy5D-ZuGFao9UjGWHD86AA/exec?route=verifyToken&token=${encodeURIComponent(this.token)}`);
