...
watch(volumeSub, (val) => {
  metronome.setVolumeSub(val);
});

watch(volumeStrong, (val) => {
  metronome.setVolumeStrong(val);
});

watch(volumeWeak, (val) => {
  metronome.setVolumeWeak(val);
});

watch(accentuateFirstBeat, (val) => {
  metronome.setAccentuateFirstBeat(val);
});
</script>
