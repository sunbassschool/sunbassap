...
<button v-if="isLoggedIn && isMobile" @click="logoutUser" class="logout-btn" title="Déconnexion">
  <i class="bi bi-box-arrow-right"></i>
</button>
...
export default {
  ...
  onMounted(async () => {
    console.log("📌 Initialisation de Layout.vue...");
    ...
    // ✅ Vérifier si IndexedDB est prête AVANT d'accéder aux tokens
    const isDBReady = await verifyIndexedDBSetup();
    if (!isDBReady) {
      console.warn("⚠️ IndexedDB non disponible, arrêt de la vérification.");
      return;
    }
