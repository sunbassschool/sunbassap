...
async fetchUserData(forceUpdate = false) {
  ...
  if (!prenom) {
    console.error("❌ Prénom manquant avant l'appel API !");
    return;
  }
  ...
  try {
    ...
    // 🔥 Vérifions que toutes les valeurs sont bien définies
    console.log("🔍 Vérification des valeurs reçues...");
    ...
    // 🔥 Test d’enregistrement dans localStorage
    try {
