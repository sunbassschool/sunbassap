...
export default {
  ...
  methods: {
    ...
    detectFrequency() {
      ...
      // Tolérance pour les variations
      const tolerance = 3; // Tolérance de 3 Hz pour les notes
      ...
      // Cas spécial pour une fréquence proche de 118 Hz (souvent détectée comme harmonique de E)
