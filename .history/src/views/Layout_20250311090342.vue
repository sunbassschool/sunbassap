...
import {  getToken, isUserLoggedIn, isUserAdmin, clearUserData, restoreTokensToIndexedDB, setTokenCookies, logoutUser, preventIndexedDBCleanup, checkAndRestoreTokens    } from "@/utils/api.ts";
import { preventIndexedDBCleanup, checkAndRestoreTokens } from "@/utils/api.ts"; // ✅ Importe les fonctions
export default {
  name: "Layout",
  setup() {
