...
export default {
  ...
  return {
    ...
    subdivisions: [
    { value: 1, label: '', icon: `${baseUrl}assets/icones/quarter-note.png` },
        { value: 2, label: '', icon: `${baseUrl}assets/icones/eighth-note.png` },
        { value: 3, label: '', icon: `${baseUrl}assets/icones/triplet.png` },
        { value: 4, label: '', icon: `${baseUrl}assets/icones/sixteenth-note.png` }
