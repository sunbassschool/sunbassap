...
,
  ...
  async // Vérifie si le métronome est déjà en cours (sessionStorage)
  const isMetronomeActive = sessionStorage.getItem("isPlaying") === "true";

  // Mettre à jour l'état isPlaying en fonction de la valeur de sessionStorage
