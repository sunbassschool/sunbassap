<template>
  ...
  { value: 2, label: 'Croches', icon: require('@/assets/icons/eighth-note.png') }, // Image locale
  { value: 3, label: 'Triolets', icon: require('@/assets/icons/triplet.png') }, // Image locale
  { value: 4, label: 'Doubles Croches', icon: require('@/assets/icons/sixteenth-note.png') } // Image locale
]
      };
    },
    methods: {
