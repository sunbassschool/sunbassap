...
export default {
  ...
  return {
    ...
    subdivisions: [
    { value: 1, label: '', icon: '/assets/icones/quarter-note.png' },
  { value: 2, label: '', icon: '/assets/icones/eighth-note.png' },
  { value: 3, label: '', icon: '/assets/icones/triplet.png' },
  { value: 4, label: '', icon: '/assets/icones/sixteenth-note.png' }
