...
export default {
  ...
  computed: {
    metronome() {
      return useMetronomeStore(); // Accéder au store Pinia
    },
    tempo: {
      get() {
      ...
      set(val) {
        this.metronome.setTempo(val); // Mise à jour du tempo dans le store
      }
    },
    volumeStrong: {
      get() {
      ...
      set(val) {
        this.metronome.setVolumeStrong(val); // Mise à jour du volume fort dans le store
      }
    },
    volumeWeak: {
      get() {
      ...
      set(val) {
        this.metronome.setVolumeWeak(val); // Mise à jour du volume faible dans le store
      }
    },
    volumeSub: {
      get() {
      ...
      set(val) {
        this.metronome.setVolumeSub(val); // Mise à jour du volume subdivision dans le store
      }
    },
    swingAmount: {
      get() {
      ...
      set(val) {
        this.metronome.setSwingAmount(val); // Mise à jour du swing dans le store
      }
    },
    subdivision: {
      get() {
      ...
      set(val) {
        this.metronome.setSubdivision(val); // Mise à jour de la subdivision dans le store
      }
    }
  },
  methods: {
