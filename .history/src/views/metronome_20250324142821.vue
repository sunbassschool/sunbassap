...
stopMetronome() {
  // Assure-toi de vérifier si le métronome est en cours de lecture avant d'appeler la logique d'arrêt
  if (this.isPlaying) {
    this.isPlaying = false;
    localStorage.setItem("isPlaying", "false"); // Réinitialiser l'état dans le stockage local
