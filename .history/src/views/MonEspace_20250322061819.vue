...
fetchURL(route) {
  ...
  // 🔐 Étape 1 : Authentifie et récupère jwt + prénom
  checkAuth().then(async ({ jwt, prenom }) => {
    if (!jwt || !prenom) {
    ...
    // Vérifie le rôle utilisateur (à garder à la fin)
    this.checkUserRole();
