      ...
      <div v-if="!isLoading" class="content">
        ...
        >
          <div class="dashboard-card rounded-3 p-4 d-flex align-items-center">
            ...
            <button @click="simulate">Test overlay</button>
...
function simulate() {
  ...
  return{
    ...
    routes: {
      GET: "AKfycbyvFb607O-JB2ZGgY9Ei1IPdoIA_AjsgdcZ_oRlBc6z1w2gK3nMnq-Sp0R6VrUoNO5lIg/exec",
       POST: "AKfycbyvFb607O-JB2ZGgY9Ei1IPdoIA_AjsgdcZ_oRlBc6z1w2gK3nMnq-Sp0R6VrUoNO5lIg/exec"
    }
  };
}
,
