...
<aside class="sidebar" :class="{ isCollapsed: isSidebarCollapsed }" v-if="!isMobile">
  ...
  <span>Prendre un cours</span>
   ...
   <router-link class="sidebar-link" to="/dashboard">
    ...
    <router-link v-if="isLoggedIn" to="/MesRessources" class="sidebar-link">
  <i class="bi bi-person-plus"></i>
  <span>Mes Ressources</span>
</router-link>
<router-link v-if="isLoggedIn" to="/Feedback" class="sidebar-link">
  <i class="bi bi-person-plus"></i>
  <span>FeedBacks</span>
</router-link>
 <router-link v-if="isLoggedIn && !isAdmin" to="/registerform" class="sidebar-link">
  <i class="bi bi-person-plus"></i>
...
<router-link to="/Feedback" class="nav-link mon-BassTuner" v-if="isLoggedIn">
