...
async fetchEleves() {
  ...
  try {
    ...
    if (Array.isArray(data)) {
      // 🧠 Tri alphabétique par prénom (insensible à la casse et accents)
      this.eleves = data.sort((a, b) =>
        a.prenom.localeCompare(b.prenom, 'fr', { sensitivity: 'base' })
      );
      console.log("✅ Éleves triés alphabétiquement :", this.eleves.map(e => e.prenom));
    } else {
