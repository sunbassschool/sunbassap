...
,
  ...
  // ✅ Mise à jour de sessionStorage et rafraîchissement de l'UI quand isPlaying change
  isPlaying(newVal) {
...
,
  ...
  // 🟢 Vérifier si le métronome était en cours au rechargement de la page
  ...
  // 🔵 Activer un faux son pour éviter l'arrêt du Web Audio
