      ...
      <div class="row justify-content-center">
        <div class="col-lg-12 col-md-10 w-100">
          <div class="card glass-card p-4 text-center animated-card">
            <!-- 🚀 Loader (pendant le chargement initial sans cache) -->
            ...
            <div v-else class="info-section">
              ...
              <!-- 📂 Ressources (affichées uniquement après vérif du cache) -->
              <div v-if="isDataReady" class="info-box resource-box">
