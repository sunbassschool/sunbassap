...
sendingFeedback: false,
        ...
        feedbackError: null,
        routes: {
          GET: "AKfycbzGVeAQ1KxqWngJdoiZRZFdG5Dsd0k1ehxN-hP5F2JOIA8Iu4Ej7m12eslhWjh7ssd2KQ/exec",
          POST: "AKfycbzGVeAQ1KxqWngJdoiZRZFdG5Dsd0k1ehxN-hP5F2JOIA8Iu4Ej7m12eslhWjh7ssd2KQ/exec"
        },
  ...
  // 🔍 Nettoyage et transformation de l'ID
  const numericId = Number(String(id).trim().replace("ID", ""));
  console.log("🧾 ID numérique final envoyé :", numericId);
  ...
  try {
    ...
    if (result.success) {
      ...
      await this.fetchFeedbacks(); // Rafraîchit la liste après suppression
    } else {
