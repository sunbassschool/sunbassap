...
async function initApp() {
  ...
  app.mount("#app");
  hideLoadingScreen(); // ✅ Masque le spinner après le montage de l'app

  // ✅ Ajout de la restauration complète des tokens
  console.log("🔄 Tentative de restauration complète des tokens...");
  await restoreAllTokens(); // 🔥 NOUVEAU : Restaure tous les tokens, où qu'ils soient !
  ...
  // Si le JWT est expiré ou absent, tente de rafraîchir le token
  if (!jwt && storedRefreshToken) {
    console.log("🔄 Tentative de rafraîchissement du token...");
    await handleRefreshToken(); // Appel de la fonction handleRefreshToken
  }
