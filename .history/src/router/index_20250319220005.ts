...
router.beforeEach(async (to, from, next) => {
  ...
  // 🟢 Si la route n'exige PAS d'authentification, on autorise immédiatement !
  if (!to.meta.requiresAuth) {
    console.log("🔓 Accès libre, pas besoin de vérifier l'authentification.");
    return next();
  }

  console.log("🔐 Page protégée détectée, vérification en cours...");

  // ⚠️ Éviter d'exécuter plusieurs vérifications en même temps
