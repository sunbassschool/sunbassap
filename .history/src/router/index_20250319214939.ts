...
router.beforeEach(async (to, from, next) => {
  ...
  console.log("🔍 Route protégée ?", to.meta.requiresAuth ? "Oui" : "Non");
  ...
  if (!to.meta.requiresAuth) {
    console.log("🔓 Page publique détectée, accès direct.");
    authCheckInProgress = false;
    return next(); // ✅ Devrait autoriser la navigation immédiatement
  }
