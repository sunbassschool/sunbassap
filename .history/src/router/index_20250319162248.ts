...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/Metronome", name: "Metronome", component: Metronome, meta: { requiresAuth: true } },
  ],
});
...
router.beforeEach(async (to, from, next) => {
  ...
  // Si la page n'a pas besoin d'authentification, on continue
  ...
  try {
    ...
    if (jwt) {
      ...
      // Si le refresh a été effectué, rediriger vers la page où l'utilisateur était
