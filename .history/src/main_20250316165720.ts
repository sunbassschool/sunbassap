...
async function initApp() {
  ...
  await restoreTokensIfNeeded(); // ✅ Restaure depuis IndexedDB
  await restoreTokensToIndexedDBIfMissing(); // ✅ Restaure depuis localStorage/sessionStorage si besoin
