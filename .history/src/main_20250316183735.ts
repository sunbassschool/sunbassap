...
import { decodeJwt } from "jsonwebtoken"; // 📌 Utiliser une lib pour décoder le JWT
...
// ✅ Simule une requête pour rafraîchir le token
async function refreshAccessToken(refreshToken) {
  ...
  return data.jwt; // Supposons que l'API retourne le nouveau JWT
}
