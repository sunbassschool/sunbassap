...
// ✅ Gestion dynamique de l'URL du logo (comme dans `IntroView.vue`)
...
onMounted(async () => {
  ...
  isLoading.value = false; // ✅ Active l'affichage de l'application directement
  
  // Désactive temporairement la redirection
