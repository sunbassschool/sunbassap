...
export async function refreshToken(): Promise<string | null> {
  ...
  // ✅ Étape 1 : Toujours récupérer depuis IndexedDB avec la nouvelle méthode
  let storedRefreshToken = await getRefreshTokenDirect();

  if (!storedRefreshToken) {
    console.warn("🚨 Aucun refresh token en IndexedDB. Tentative de récupération...");
    return null;
  }
  ...
  try {
    // ✅ Étape 2 : Appel API pour rafraîchir le JWT
    ...
    // ✅ Étape 3 : Stockage sécurisé du nouveau JWT
