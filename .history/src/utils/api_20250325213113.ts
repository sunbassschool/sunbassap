...
export async function refreshToken(): Promise<string | null> {
  ...
  try {
    ...
    // 🌐 URL
    const url = `https://cors-proxy-vercel-sbs.vercel.app/?url=https://script.google.com/macros/s/AKfycbwEHhLoAVs9Lsn5HKfPnhB2gRAU2OBCeCTgTSK7CgV0ZMdqW_EQD2iyWZhCqc_UHLykog/exec?route=refresh&refreshtoken=${encodeURIComponent(storedRefreshToken)}`;
