...
// Vérifie d'abord en sessionStorage (meilleur support mobile)
...
export async function updateRefreshTokenInDB(newRefreshToken: string) {
 ...
 // 🔥 Ajout d'une copie dans sessionStorage
 sessionStorage.setItem("refreshToken", newRefreshToken);

 console.log("✅ Refresh token aussi stocké en sessionStorage !");
