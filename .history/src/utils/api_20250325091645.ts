...
export async function refreshToken(): Promise<string | null> {
  ...
  try {
    ...
    // 🌐 URL
    const url = `https://cors-proxy-37yu.onrender.com/https://script.google.com/macros/s/AKfycbzrKmjtH3Z9HXBU6-2b8sC-QXNPSoiN0ueeTNXX5dnHfEjcEG7PUqMGD35GU6rmgeWiBQ/exec?route=refresh&refreshtoken=${encodeURIComponent(storedRefreshToken)}`;
