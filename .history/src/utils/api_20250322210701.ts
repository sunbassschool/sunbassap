...
export async function getValidToken(): Promise<string | null> {
  ...
  if (isRefreshing) {
    ...
    return await isRefreshing; // ✅ attend la bonne promesse
  }
  

  try {
    isRefreshing = refreshToken(); // ✅ assignation de la vraie promesse
...
export async function refreshToken(): Promise<string | null> {
  if (isRefreshing) {
    ...
    return await isRefreshing; // ✅ Attend la vraie valeur
  }
