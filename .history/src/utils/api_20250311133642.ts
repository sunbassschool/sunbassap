...
export function setTokenCookies(jwt: string | undefined, refreshToken: string | undefined) {
  if (!refreshToken) return; // Ne crée pas de cookie si le refreshToken est indéfini
