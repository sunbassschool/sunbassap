...
export function isJwtExpired(token: string | null): boolean {
  ...
  // ✅ Vérification du format JWT (3 parties séparées par des ".")
  ...
  try {
    ...
    // ✅ Convertir la payload (2e partie) en Base64 URL-safe
    const payloadBase64 = jwtParts[1]
      .replace(/-/g, "+") // 🔄 Convertir Base64 URL-safe en Base64 standard
      .replace(/_/g, "/");
