...
export async function refreshToken(): Promise<string | null> {
  ...
  if (storedRefreshToken.includes(".")) { // 🔥 Un JWT contient toujours au moins 2 points `.`
    console.error("⚠️ [ERREUR] Le refresh token ressemble à un JWT ! Mauvaise extraction ?");
    return null;
  }
