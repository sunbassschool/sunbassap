...
function removeItemFromStore(key: string, storeType: "local" | "session" = "local") {
  if (storeType === "local" && window.localStorage.getItem(key)) {
    window.localStorage.removeItem(key);
  } else if (storeType === "session" && window.sessionStorage.getItem(key)) {
