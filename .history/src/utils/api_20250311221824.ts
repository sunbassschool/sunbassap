...
import { getRefreshTokenFromDB, updateTokens } from "@/utils/api.ts"; // On importe correctement les fonctions
...
async function attemptTokenRefresh(storedRefreshToken: string): Promise<any> {
  ...
  try {
    ...
    console.log("🔄 [DEBUG] Tentative de récupération du refreshToken depuis IndexedDB avec `getRefreshTokenFromDB`...");
