...
export async function logoutUser() {
  ...
  try {
    ...
    logoutMessage.innerText = "🔄 Déconnexion en cours...";
    ...
    logoutMessage.style.padding = "15px";
    logoutMessage.style.background = "#333";
    logoutMessage.style.color = "#fff";
    logoutMessage.style.fontSize = "18px";
    logoutMessage.style.borderRadius = "5px";
    logoutMessage.style.zIndex = "9999";
    document.body.appendChild(logoutMessage);

    // 🗑️ Suppression des tokens et données utilisateur
    ...
    // ✅ **Redirection finale après nettoyage**
    setTimeout(() => {
      console.log("🔄 Redirection vers la page de connexion...");
      window.location.href = "/login";
    }, 1000); // 🔥 Petite attente pour que l'utilisateur voie le message
