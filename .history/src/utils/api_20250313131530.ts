...
export async function getToken(): Promise<string | null> {
  ...
  // ✅ Si IndexedDB retourne un objet, on extrait la valeur (en supposant que c'est une propriété `value` ou similaire)
  // Supposons que tokenObj soit un objet avec une propriété `jwt`
  let token = (tokenObj && typeof tokenObj === 'object' && 'jwt' in tokenObj) ? tokenObj.jwt : tokenObj;

// Remplacer `value` ou `jwt` par la bonne clé
