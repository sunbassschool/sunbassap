...
function initAudioContext() {
  if (!audioContext) {
    ...
    // Cette ligne est nécessaire pour iOS
    audioContext.resume();
  }
}
...
async function loadSounds() {
  const urls = {
    strong: '${import.meta.env.VITE_BASE_URL}assets/assets/audio/strong-beat.wav',
    weak: '${import.meta.env.VITE_BASE_URL}assets/assets/audio/weak-beat.wav',
    sub: '${import.meta.env.VITE_BASE_URL}assets/assets/audio/subdivision.wav',
  }
