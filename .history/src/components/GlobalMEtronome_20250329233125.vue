...
,
  ...
  // Choix du son
  const isFirstSub = this.metronome.currentSubdivision === 1;
const nextBeat = this.metronome.currentBeat;
const nextSub = this.metronome.currentSubdivision;

const isStrongBeat =
  nextBeat === 1 &&
  nextSub === 1 &&
  !this.metronome.disableStrongBeat;

if (this.metronome.currentSubdivision === 1) {
