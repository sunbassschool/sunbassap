...
export default {
  ...
  computed: {
    ...
    swingAmount: {
      ...
      set(value) {
        this.metronome.swingAmount = value; // Met à jour la valeur dans le store
      }
    },
    tempo: {
      get() {
  ...
  methods: {
    ...
    updateSwingAmount() {
      // L'action est déjà synchronisée grâce au v-model
      this.metronome.swingAmount = this.swingAmount; // Mise à jour explicite si nécessaire
    },
