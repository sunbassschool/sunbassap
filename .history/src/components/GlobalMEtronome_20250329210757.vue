...
export default {
  ...
  // ✅ Remise à zéro avant de démarrer
  ...
  // ✅ Déclencher immédiatement le premier clic
...
,
  ...
  const isAccentedBeat = this.metronome.currentBeat === this.metronome.accentedBeat;
  let buffer, volume;
  ...
  if (isFirstSub) {
    if (isAccentedBeat && !this.metronome.disableStrongBeat) {
