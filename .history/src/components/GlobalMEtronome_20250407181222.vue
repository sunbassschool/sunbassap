...
this.timerInterval = setInterval(() => this.elapsedTime++, 1000);
  ...
  this.startKeepAwake(); // 🔁 Démarre la boucle anti-sleep JS (option 2)

  // 🎧 Lancer le silence.mp3 pour maintenir session audio active sur iOS
