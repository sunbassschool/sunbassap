...
export const useAuthStore = defineStore("auth", {
  ...
  actions: {
    ...
    async refreshJwt() {
      ...
      let overlayTimeout;
      try {
        // ⚠️ Ne pas le mettre à false ici (sinon l’UI croit que tout va bien dès le départ)
    
        overlayTimeout = setTimeout(() => {
          this.isRefreshingToken = true;
        }, 400); // Si ça prend du temps, on affiche un overlay
        ...
        this.isRefreshingToken = false; // ✅ on masque l’overlay ici
      }
    }
