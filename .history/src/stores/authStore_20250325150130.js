...
export const useAuthStore = defineStore("auth", {
    state: () => ({
        ...
        // S'il manque une virgule ici, cela entraînera une erreur
        setUserToken: (token: string) { // Erreur ici à cause des deux-points
          this.jwt = token;
        }
      }),
  ...
  actions: {
    ...
    async refreshJwt() {
      ...
      try {
        ...
        this.setUserToken(newJwt); // Utilisation de la méthode setUserToken pour mettre à jour le JWT
